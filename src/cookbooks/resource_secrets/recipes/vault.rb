...
# region.hcl
vault_metrics_template_file = node['hashicorp-vault']['consul_template_metrics_file']
file "#{consul_template_template_path}/#{vault_metrics_template_file}" do
  action :create
  content <<~CONF
    telemetry {
...
file "#{consul_template_config_path}/vault_metrics.hcl" do
  action :create
  content <<~HCL
    ...
    template {
      ...
      # the `contents` option.
      source = "#{consul_template_template_path}/#{vault_metrics_template_file}"

      # This is the destination path on disk where the source template will render.
      # If the parent directories do not exist, Consul Template will attempt to
      # create them, unless create_dest_dirs is false.
      destination = "#{vault_config_path}/#{vault_metrics_file}"
